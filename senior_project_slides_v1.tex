...
\begin{frame}{DUI vs Crash Rate}
\phantomsection\label{dui-vs-crash-rate}
\begin{center}\includegraphics{senior_project_slides_v1_files/figure-beamer/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics{senior_project_slides_v1_files/figure-beamer/ci-all-plot-1} \end{center}
\end{frame}
