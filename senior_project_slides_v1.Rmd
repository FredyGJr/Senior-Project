...
The data were gathered from the Texas Department of Transportation Motor Vehicle Crash Statistics site:

\small
\url{https://www.txdot.gov/data-maps/crash-reports-records/motor-vehicle-crash-statistics.html}
\normalsize

The county-level values were compiled from the 2024 PDF reports for total crashes, DUI crashes, distracted-driving crashes, speed-related crashes, and fatal crashes.
